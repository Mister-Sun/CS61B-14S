...
public class DListNode extends ListNode {
    ...
    public void insertAfter(Object item) throws InvalidNodeException {
        if (!isValidNode()) {
            ...
            //DListNode newNode = newNode(item, myList, this, this.next);
            DListNode newNode = new DListNode(item, (DList) myList, this, this.next);
    ...
    public void insertBefore(Object item) throws InvalidNodeException {
        if (!isValidNode()) {
            ...
            DListNode newNode = new DListNode(item, (DList)myList, this.prev, this);
